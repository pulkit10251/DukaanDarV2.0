...
const ProfileScreenAdmin = (props) => {
  ...
  const DukaanDarId = useSelector((state) => state.dukanId.shopId)
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ marginTop: 120 }}>
        ...
        <View style={styles.textContainer}>
          <Text style={styles.textBold}>DukaanDar Id : </Text>
          <Text style={{...styles.text, textTransform : "uppercase"}}>{DukaanDarId}</Text>
        </View>
      </View>
    </View>
  );
...
ProfileScreenAdmin.navigationOptions = (NavData) => {
  return {
