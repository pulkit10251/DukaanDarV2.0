...
export default (state = initialState, action) => {
  switch (action.type) {
    case "REMOVE_GLOBAL_CATEGORY": {
      ...
      const shop = state.ShopData[shopId];
      ...
      return {
        ...state,
        ShopData: {...ShopData, [shopId] : updatedStore}
      };
    }
    case "REMOVE_LOCAL_CATEGORY": {
      ...
      const selectedStore = state.ShopData[shopId]
    ...
    case "ADD_GLOBAL_CATEGORY": {
      ...
      const selectedStore = state.ShopData[shopId];
      var globalCategories = selectedStore.shop_Categories === undefined ? [] : selectedStore.shop_Categories;
    ...
    case "ADD_SHOP": {
      ...
      return {
        ...state,
        ShopData: {...ShopData, [shopId] : newStore}
      };
    }
    case "FETCH_SHOP": {
